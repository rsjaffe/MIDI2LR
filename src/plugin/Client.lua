...
-------------end preferences section
    ...
    local ACTIONS = {
      ...
      QuickDevDehazeLarge             = CU.quickDevAdjust('Dehaze',20,'QuickDevDehazeLarge'),
      QuickDevDehazeLargeDec          = CU.quickDevAdjust('Dehaze',-20,'QuickDevDehazeLargeDec'),
      QuickDevDehazeSmall             = CU.quickDevAdjust('Dehaze',5,'QuickDevDehazeSmall'),
      QuickDevDehazeSmallDec          = CU.quickDevAdjust('Dehaze',-5,'QuickDevDehazeSmallDec'),
      ...
      QuickDevTextureLarge            = CU.quickDevAdjust('Texture',20,'QuickDevTextureLarge'),
      QuickDevTextureLargeDec         = CU.quickDevAdjust('Texture',-20,'QuickDevTextureLargeDec'),
      QuickDevTextureSmall            = CU.quickDevAdjust('Texture',5,'QuickDevTextureSmall'),
      QuickDevTextureSmallDec         = CU.quickDevAdjust('Texture',-5,'QuickDevTextureSmallDec'),
