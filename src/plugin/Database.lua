...
--
  ...
  {Command='ResetSplitToningShadowHue',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningShadowHue=Shadow Hue')),Group=splitToning,Explanation='Reset to default.',Panel='splitToningPanel'},
  {Command='ResetSplitToningShadowSaturation',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningShadowSaturation=Shadow Saturation')),Group=splitToning,Explanation='Reset to default.',Panel='splitToningPanel'},
  {Command='ResetSplitToningHighlightHue',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningHighlightHue=Highlight Hue')),Group=splitToning,Explanation='Reset to default.',Panel='splitToningPanel'},
  {Command='ResetSplitToningHighlightSaturation',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningHighlightSaturation=Highlight Saturation')),Group=splitToning,Explanation='Reset to default.',Panel='splitToningPanel'},
  {Command='ResetSplitToningBalance',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningBalance=Split Toning Balance')),Group=splitToning,Explanation='Reset to default.',Panel='splitToningPanel'},
--
...
for _,v in ipairs(DataBase) do
  ...
  --for older versions of Lightroom that use years instead of numbers
  CmdTrans[v.Command][2003] = CmdTrans[v.Command][1]
  CmdTrans[v.Command][2010] = CmdTrans[v.Command][2]
  CmdTrans[v.Command][2012] = CmdTrans[v.Command][3]
  if v.Panel then
