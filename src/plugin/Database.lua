...
--
  ...
  {Command='ResetAllSaturationAdjustment',Type='button',Translation=LOC('$$$/AgCameraRawController/TargetAdjustment/Reset=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/SaveNamedDialog/Saturation=Saturation')..' \226\128\148 '..LOC('$$$/AgDateManagement/ChangeAll=Change all')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
