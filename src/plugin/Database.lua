...
--rating
  ...
  {Command='CropConstrainToWarp',Type='button',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/CropConstrainToWarp=Constrain to Warp'),Group=transform,Explanation='Enable or disable Constrain Crop. Takes effect in both Transforms panel and Crop panel.',Panel='lensCorrectionsPanel'},
