...
--rating
  ...
  {Command='ResetTexture',Type='button',Experimental=true,Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawUI/Texture=Texture')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
...
--
  ...
  {Command='SplitToningHighlightHue',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningHighlightHue=Highlight Hue'),Group=colorGrading,Explanation='Adjust color grading highlight hue.',Panel='colorGradingPanel'},
  ...
  {Command='SplitToningShadowHue',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningShadowHue=Shadow Hue'),Group=colorGrading,Explanation='Adjust color grading shadow hue.',Panel='colorGradingPanel'},
  ...
  {Command='ResetSplitToningBalance',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeBalance=Color Grading Balance')),Group=colorGrading,Explanation='Reset color grading balance to default.',Panel='colorGradingPanel'},
  ...
  {Command='ResetSplitToningHighlightHue',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningHighlightHue=Highlight Hue')),Group=colorGrading,Explanation='Reset color grading highlight hue to default.',Panel='colorGradingPanel'},
  ...
  {Command='ResetSplitToningHighlightSaturation',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningHighlightSaturation=Highlight Saturation')),Group=colorGrading,Explanation='Reset color grading highlight saturation to default.',Panel='colorGradingPanel'},
  ...
  {Command='ResetSplitToningShadowHue',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningShadowHue=Shadow Hue')),Group=colorGrading,Explanation='Reset color grading shadow hue to default.',Panel='colorGradingPanel'},
  ...
  {Command='ResetSplitToningShadowSaturation',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningShadowSaturation=Shadow Saturation')),Group=colorGrading,Explanation='Reset color grading shadow saturation to default.',Panel='colorGradingPanel'},
--
...
--
  ...
  {Command='local_Texture',Type='parameter',Translation=locadj..' '..LOC('$$$/AgCameraRawUI/Texture=Texture'),Group=localizedAdjustments,Explanation='Adjust Texture for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  ...
  {Command='local_Hue',Translation=locadj..' '..LOC('$$$/MIDI2LR/Database/Hue=Hue')..' (PV 5+)',PV5=locadj..' '..LOC('$$$/MIDI2LR/Database/Hue=Hue'),Group=localizedAdjustments,Explanation='Adjust Hue for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  ...
  {Command='Resetlocal_Texture',Type='button',Experimental=true,Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgCameraRawUI/Texture=Texture')),Group=localadjresets,Explanation='Reset to default.'},
