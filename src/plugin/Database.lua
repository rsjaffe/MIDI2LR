...
--local adjustment resets 
  ...
  {Command='Resetlocal_Hue',Translation=reset..' '..locadj..' '..LOC('$$$/MIDI2LR/Database/Hue=Hue')..' (PV 5+)',PV5=reset..' '..locadj..' '..LOC('$$$/MIDI2LR/Database/Hue=Hue'),Group=localadjresets,Explanation='Reset to default.'},  
