...
--
  ...
  {Command='local_Dehaze',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Dehaze=Dehaze')..' (PV 3+)',PV3=locadj..' '..LOC('$$$/AgDevelop/Localized/Dehaze=Dehaze'),Group=localizedAdjustments,Explanation='Adjust Dehaze for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
   {Command='local_Hue',Translation='$$$/MIDI2LR/Database/LocalHue=Local hue'..' (PV 5+)',PV5='$$$/MIDI2LR/Database/LocalHue=Local hue',Group=localizedAdjustments,Explanation='Adjust Hue for the currently active tool: Brush, Radial Filter, or Graduated Filter. For Lightroom version 9.3 and later.'},
...
--local adjustment resets 
  ...
  {Command='Resetlocal_Hue',Translation=reset..' '..'$$$/MIDI2LR/Database/LocalHue=Local hue'..' (PV 5+)',PV5=reset..' '..'$$$/MIDI2LR/Database/LocalHue=Local hue',Group=localizedAdjustments,Explanation='Reset to default.'},  
