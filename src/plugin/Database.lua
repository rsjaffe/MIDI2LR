...
--rating
  ...
  {Command='ResetLast',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/LibraryUpgradeCatalogUtils/CatalogInfo/LastModified/Label=Last Modified'):gsub(':','')),Group=develop,Explanation='Resets the last parameter that was adjusted by an encoder or fader to default.'},
  ...
  {Command='ChangeCurrentSlider',Type='repeat',Translation=LOC('$$$/ImportView/More=More')..' – '..LOC('$$$/ImportView/Less=Less'),Group=develop,Explanation='Adjusts selected develop slider up or down. Turning knob clockwise sends Increment (<kbd>\240\159\161\146 Cursor Right</kbd>) keystrokes to Lightroom, counterclockwise Decrement (<kbd>\240\159\161\144 Cursor Left</kbd>).'..repeatexp},
  {Command='SliderIncrease',Type='button',Translation=LOC('$$$/ImportView/More=More'),Group=develop,Explanation='Sends the keystroke <kbd>\240\159\161\146 Cursor Right</kbd> to Lightroom. Increases the selected develop slider.'},
  {Command='SliderDecrease',Type='button',Translation=LOC('$$$/ImportView/Less=Less'),Group=develop,Explanation='Sends the keystroke <kbd>\240\159\161\144 Cursor Left</kbd> to Lightroom. Decreases the selected develop slider.'},
  ...
  {Command='ResetTemperature',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/Temperature=Temperature')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetTint',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawUI/Tint=Tint')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetExposure',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawUI/Exposure=Exposure')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetContrast',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawUI/Contrast=Contrast')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetHighlights',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawUI/Highlights=Highlights')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetShadows',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawUI/Shadows=Shadows')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetWhites',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawUI/Whites=Whites')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetBlacks',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawUI/Blacks=Blacks')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetTexture',Type='button',Experimental=true,Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawUI/Texture=Texture')),Group=basicTone,Explanation='Reset to default. For Lightroom version 8.3 and later.',Panel='adjustPanel'},
  {Command='ResetClarity',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawUI/Clarity=Clarity')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetDehaze',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawUI/DehazeAmount=Dehaze Amount')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},  
  {Command='ResetVibrance',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawUI/Vibrance=Vibrance')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetSaturation',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawUI/Saturation=Saturation')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
--
...
--
  ...
  {Command='ResetParametricDarks',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ToneDarks=Dark Tones')),Group=toneCurve,Explanation='Reset to default.',Panel='tonePanel'},
  {Command='ResetParametricLights',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ToneLights=Light Tones')),Group=toneCurve,Explanation='Reset to default.',Panel='tonePanel'},
  {Command='ResetParametricShadows',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ToneShadows=Shadow Tones')),Group=toneCurve,Explanation='Reset to default.',Panel='tonePanel'},
  {Command='ResetParametricHighlights',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ToneHighlights=Highlight Tones')),Group=toneCurve,Explanation='Reset to default.',Panel='tonePanel'},
  {Command='ResetParametricShadowSplit',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ToneShadowSplit=Shadow Split')),Group=toneCurve,Explanation='Reset to default.',Panel='tonePanel'},
  {Command='ResetParametricMidtoneSplit',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ToneMidtoneSplit=Midtone Split')),Group=toneCurve,Explanation='Reset to default.',Panel='tonePanel'},
  {Command='ResetParametricHighlightSplit',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ToneHighlightSplit=Highlight Split')),Group=toneCurve,Explanation='Reset to default.',Panel='tonePanel'},
...
--
  ...
  {Command='ResetSaturationAdjustmentRed',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentRed=Saturation Adjustment Red')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetSaturationAdjustmentOrange',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentOrange=Saturation Adjustment Orange')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetSaturationAdjustmentYellow',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentYellow=Saturation Adjustment Yellow')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetSaturationAdjustmentGreen',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentGreen=Saturation Adjustment Green')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetSaturationAdjustmentAqua',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentAqua=Saturation Adjustment Aqua')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetSaturationAdjustmentBlue',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentBlue=Saturation Adjustment Blue')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetSaturationAdjustmentPurple',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentPurple=Saturation Adjustment Purple')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetSaturationAdjustmentMagenta',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentMagenta=Saturation Adjustment Magenta')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetAllSaturationAdjustment',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/SaveNamedDialog/Saturation=Saturation')..' \226\128\148 '..LOC('$$$/AgDateManagement/ChangeAll=Change all')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetHueAdjustmentRed',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentRed=Hue Adjustment Red')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetHueAdjustmentOrange',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentOrange=Hue Adjustment Orange')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetHueAdjustmentYellow',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentYellow=Hue Adjustment Yellow')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetHueAdjustmentGreen',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentGreen=Hue Adjustment Green')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetHueAdjustmentAqua',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentAqua=Hue Adjustment Aqua')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetHueAdjustmentBlue',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentBlue=Hue Adjustment Blue')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetHueAdjustmentPurple',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentPurple=Hue Adjustment Purple')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetHueAdjustmentMagenta',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentMagenta=Hue Adjustment Magenta')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetLuminanceAdjustmentRed',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentRed=Luminance Adjustment Red')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetLuminanceAdjustmentOrange',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentOrange=Luminance Adjustment Orange')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetLuminanceAdjustmentYellow',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentYellow=Luminance Adjustment Yellow')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetLuminanceAdjustmentGreen',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentGreen=Luminance Adjustment Green')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetLuminanceAdjustmentAqua',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentAqua=Luminance Adjustment Aqua')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetLuminanceAdjustmentBlue',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentBlue=Luminance Adjustment Blue')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetLuminanceAdjustmentPurple',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentPurple=Luminance Adjustment Purple')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetLuminanceAdjustmentMagenta',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentMagenta=Luminance Adjustment Magenta')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetGrayMixerRed',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerRed=Gray Mixer Red')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetGrayMixerOrange',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerOrange=Gray Mixer Orange')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetGrayMixerYellow',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerYellow=Gray Mixer Yellow')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetGrayMixerGreen',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerGreen=Gray Mixer Green')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetGrayMixerAqua',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerAqua=Gray Mixer Aqua')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
  {Command='ResetGrayMixerBlue',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerBlue=Gray Mixer Blue')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel'},
...
--
  {Command='RevealPanelColorGrading',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Show1=Show ^1',colorGrading),Group=colorGrading,Explanation='Open Color Grading Panel in Develop Module. Available in Lightroom version 10 or later.'},
  {Command='EnableColorGrading',Type='button',Translation=LOC('$$$/AgDevelop/Settings/ToggleColorGrading=Color grading enable/disable'),Group=colorGrading,Explanation='Enable or disable color grading. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeBlending',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeBlending=Color Blending'),Group=colorGrading,Explanation='Color grading blending changes the transition between each range: highlight, midtone, shadow. More blending gives a broader transition. The legacy Split Toning panel used a blending value of 100. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='SplitToningBalance',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeBalance=Color Grading Balance'),Group=colorGrading,Explanation='Set the Balance slider to balance the effect between the Highlight and Shadow sliders. Positive values moves more of the image into the highlight slider range; negative values moves more of the image into the shadows slider range. Midtones are shifted as well. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeGlobalHue',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeGlobalHue=Global Hue'),Group=colorGrading,Explanation='Adjust color grading global hue. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeGlobalLum',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeGlobalLum=Global Luminance'),Group=colorGrading,Explanation='Adjust color grading global luminance. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeGlobalSat',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeGlobalSat=Global Saturation'),Group=colorGrading,Explanation='Adjust color grading global saturation. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='SplitToningHighlightHue',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningHighlightHue=Highlight Hue'),Group=colorGrading,Explanation='Adjust color grading highlight hue. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeHighlightLum',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeHighlightLum=Highlight Luminance'),Group=colorGrading,Explanation='Adjust color grading highlight luminance. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='SplitToningHighlightSaturation',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningHighlightSaturation=Highlight Saturation'),Group=colorGrading,Explanation='Adjust color grading highlight saturation. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeMidtoneHue',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeMidtoneHue=Midtone Hue'),Group=colorGrading,Explanation='Adjust color grading midtone hue. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeMidtoneLum',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeMidtoneLum=Midtone Luminance'),Group=colorGrading,Explanation='Adjust color grading midtone luminance. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeMidtoneSat',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeMidtoneSat=Midtone Saturation'),Group=colorGrading,Explanation='Adjust color grading midtone saturation. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='SplitToningShadowHue',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningShadowHue=Shadow Hue'),Group=colorGrading,Explanation='Adjust color grading shadow hue. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeShadowLum',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeShadowLum=Shadow Luminance'),Group=colorGrading,Explanation='Adjust color grading shadow luminance. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='SplitToningShadowSaturation',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningShadowSaturation=Shadow Saturation'),Group=colorGrading,Explanation='Adjust color grading shadow saturation. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeCopy',Type='button',Translation=LOC('$$$/AgDevelop/ColorGrading/ChannelSettings/Copy=Copy channel settings'),Group=colorGrading,Explanation='Copy settings from currently displayed channel. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradePaste',Type='button',Translation=LOC('$$$/AgDevelop/ColorGrading/ChannelSettings/Paste=Paste channel settings'),Group=colorGrading,Explanation='Paste settings to currently displayed channel. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeReset3way',Type='button',Translation=LOC('$$$/AgDevelop/ColorGrading/ResetChannel/ThreeWay=Reset 3-way'),Group=colorGrading,Explanation='Reset all channels in 3-way view. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeResetCurrent',Type='button',Translation=LOC('$$$/AgDevelop/ColorGrading/ResetChannel/Current=Reset ^1',LOC('$$$/AgDevelop/BeforeAfter/Current=current')),Group=colorGrading,Explanation='Reset currently viewed channel(s). Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeResetAll',Type='button',Translation=LOC('$$$/AgDevelop/ColorGrading/ResetChannel/All=Reset all channels'),Group=colorGrading,Explanation='Reset all channels. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGrade3Way',Type='button',Translation=LOC('$$$/AgDevelop/ColorGrading/Peeking/Tooltip=Click for ^1 View',LOC('$$$/CRaw/ColorGrading/Tips/3Way=3-Way')),Group=colorGrading,Explanation='Display 3-way view in color grading panel. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeGlobal',Type='button',Translation=LOC('$$$/AgDevelop/ColorGrading/Peeking/Tooltip=Click for ^1 View',LOC('$$$/CRaw/ColorGrading/Tips/Global=Global')),Group=colorGrading,Explanation='Display global channel in color grading panel. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeHighlight',Type='button',Translation=LOC('$$$/AgDevelop/ColorGrading/Peeking/Tooltip=Click for ^1 View',LOC('$$$/CRaw/ColorGrading/Tips/Highlights=Highlights')),Group=colorGrading,Explanation='Display highlights channel in color grading panel. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeMidtone',Type='button',Translation=LOC('$$$/AgDevelop/ColorGrading/Peeking/Tooltip=Click for ^1 View',LOC('$$$/CRaw/ColorGrading/Tips/Midtones=Midtones')),Group=colorGrading,Explanation='Display midtones channel in color grading panel. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ColorGradeShadow',Type='button',Translation=LOC('$$$/AgDevelop/ColorGrading/Peeking/Tooltip=Click for ^1 View',LOC('$$$/CRaw/ColorGrading/Tips/Shadows=Shadows')),Group=colorGrading,Explanation='Display shadows channel in color grading panel. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeBlending',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeBlending=Color Blending')),Group=colorGrading,Explanation='Reset color grading blending to default. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ResetSplitToningBalance',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeBalance=Color Grading Balance')),Group=colorGrading,Explanation='Reset color grading balance to default. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeGlobalHue',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeGlobalHue=Global Hue')),Group=colorGrading,Explanation='Reset color grading global hue to default. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeGlobalLum',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeGlobalLum=Global Luminance')),Group=colorGrading,Explanation='Reset color grading global luminance to default. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeGlobalSat',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeGlobalSat=Global Saturation')),Group=colorGrading,Explanation='Reset color grading global saturation to default. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ResetSplitToningHighlightHue',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningHighlightHue=Highlight Hue')),Group=colorGrading,Explanation='Reset color grading highlight hue to default. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeHighlightLum',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeHighlightLum=Highlight Luminance')),Group=colorGrading,Explanation='Reset color grading highlight luminance to default. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ResetSplitToningHighlightSaturation',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningHighlightSaturation=Highlight Saturation')),Group=colorGrading,Explanation='Reset color grading highlight saturation to default. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeMidtoneHue',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeMidtoneHue=Midtone Hue')),Group=colorGrading,Explanation='Reset color grading midtone hue to default. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeMidtoneLum',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeMidtoneLum=Midtone Luminance')),Group=colorGrading,Explanation='Reset color grading midtone luminance to default. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeMidtoneSat',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeMidtoneSat=Midtone Saturation')),Group=colorGrading,Explanation='Reset color grading midtone saturation to default. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ResetSplitToningShadowHue',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningShadowHue=Shadow Hue')),Group=colorGrading,Explanation='Reset color grading shadow hue to default. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeShadowLum',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeShadowLum=Shadow Luminance')),Group=colorGrading,Explanation='Reset color grading shadow luminance to default. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
  {Command='ResetSplitToningShadowSaturation',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningShadowSaturation=Shadow Saturation')),Group=colorGrading,Explanation='Reset color grading shadow saturation to default. Available in Lightroom version 10 or later.',Panel='colorGradingPanel'},
--
...
--
  ...
  {Command='ResetSharpness',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgDevelop/Localized/Sharpness=Sharpness')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetSharpenRadius',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SharpenRadius=Sharpen Radius')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetSharpenDetail',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SharpenDetail=Sharpen Detail')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetSharpenEdgeMasking',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SharpenEdgeMasking=Sharpen Edge Masking')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetLuminanceSmoothing',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceSmoothing=Luminance Smoothing')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetLuminanceNoiseReductionDetail',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceNoiseReductionDetail=Luminance Detail')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetLuminanceNoiseReductionContrast',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceNoiseReductionContrast=Luminance Contrast')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetColorNoiseReduction',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorNoiseReduction=Color Noise Reduction')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetColorNoiseReductionDetail',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorNoiseReductionDetail=Color Noise Reduction Detail')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetColorNoiseReductionSmoothness',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorNoiseReductionSmoothness=Color Noise Reduction Smoothness')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
--
...
--
  ...
  {Command='ResetLensProfileDistortionScale',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LensProfileDistortionScale=Lens Profile Distortion Scale')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetLensProfileChromaticAberrationScale',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LensProfileChromaticAberrationScale=Lens Profile Chromatic Aberration Scale')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetLensProfileVignettingScale',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LensProfileVignettingScale=Lens Profile Vignetting Scale')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  ...
  {Command='ResetDefringePurpleAmount',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PurpleDefringeAmount=Defringe Purple Amount')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetDefringePurpleHueLo',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',dph..' - '..LOC('$$$/Slideshow/Panels/PanAndZoom/Low=Low')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetDefringePurpleHueHi',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',dph..' - '..LOC('$$$/Slideshow/Panels/PanAndZoom/High=High')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetDefringeGreenAmount',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GreenDefringeAmount=Defringe Green Amount')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetDefringeGreenHueLo',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',dgh..' - '..LOC('$$$/Slideshow/Panels/PanAndZoom/Low=Low')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetDefringeGreenHueHi',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',dgh..' - '..LOC('$$$/Slideshow/Panels/PanAndZoom/High=High')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  ...
  {Command='ResetLensManualDistortionAmount',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LensManualDistortionAmount=Lens Manual Distortion Amount')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetVignetteAmount',Type='button',Experimental=true,Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/VignetteAmount=Vignette Amount')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetVignetteMidpoint',Type='button',Experimental=true,Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/VignetteMidpoint=Vignette Midpoint')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
--
...
--
  ...
  {Command='ResetPerspectiveVertical',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PerspectiveVertical=Perspective Vertical')),Group=transform,Explanation='Reset to default.',Panel='transformPanel'},
  {Command='ResetPerspectiveHorizontal',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PerspectiveHorizontal=Perspective Horizontal')),Group=transform,Explanation='Reset to default.',Panel='transformPanel'},
  {Command='ResetPerspectiveRotate',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PerspectiveRotate=Perspective Rotate')),Group=transform,Explanation='Reset to default.',Panel='transformPanel'},
  {Command='ResetPerspectiveScale',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PerspectiveScale=Perspective Scale')),Group=transform,Explanation='Reset to default.',Panel='transformPanel'},
  {Command='ResetPerspectiveAspect',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PerspectiveAspect=Perspective Aspect')),Group=transform,Explanation='Reset to default.',Panel='transformPanel'},
  {Command='ResetPerspectiveX',Type='button',Experimental=true,Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PerspectiveX=Perspective X')),Group=transform,Explanation='Reset to default.',Panel='transformPanel'},
  {Command='ResetPerspectiveY',Type='button',Experimental=true,Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PerspectiveY=Perspective Y')),Group=transform,Explanation='Reset to default.',Panel='transformPanel'},
--
...
--
  ...
  {Command='ResetPostCropVignetteAmount',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PostCropVignetteAmount=Post Crop Vignette Amount')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  {Command='ResetPostCropVignetteMidpoint',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PostCropVignetteMidpoint=Post Crop Vignette Midpoint')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  {Command='ResetPostCropVignetteFeather',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PostCropVignetteFeather=Post Crop Vignette Feather')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  {Command='ResetPostCropVignetteRoundness',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PostCropVignetteRoundness=Post Crop Vignette Roundness')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  {Command='ResetPostCropVignetteStyle',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PostCropVignetteStyle=Post Crop Vignette Style')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  {Command='ResetPostCropVignetteHighlightContrast',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PostCropVignetteHighlightContrast=Post Crop Vignette Highlight Contrast')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  {Command='ResetGrainAmount',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrainAmount=Grain Amount')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  {Command='ResetGrainSize',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrainSize=Grain Size')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  {Command='ResetGrainFrequency',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrainRoughness=Grain Roughness')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
--
...
--
  ...
  {Command='ResetShadowTint',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ShadowTintCalibration=Shadow Tint Calibration')),Group=calibration,Explanation='Reset to default.',Panel='calibratePanel'},
  {Command='ResetRedHue',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/RedHueCalibration=Red Hue Calibration')),Group=calibration,Explanation='Reset to default.',Panel='calibratePanel'},
  {Command='ResetRedSaturation',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/RedSaturationCalibration=Red Saturation Calibration')),Group=calibration,Explanation='Reset to default.',Panel='calibratePanel'},
  {Command='ResetGreenHue',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GreenHueCalibration=Green Hue Calibration')),Group=calibration,Explanation='Reset to default.',Panel='calibratePanel'},
...
--
  ...
  {Command='local_Tint',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Tint=Tint')..' (PV 3+)',PV3=locadj..' '..LOC('$$$/AgDevelop/Localized/Tint=Tint'),Group=localizedAdjustments,Explanation='Adjust Tint for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Exposure',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Exposure=Exposure')..' ('..P2and3plus..')',PV2=locadj..' '..LOC('$$$/AgDevelop/Localized/Exposure=Exposure'),Group=localizedAdjustments,Explanation='Adjust Exposure for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Contrast',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Contrast=Contrast')..' ('..P2and3plus..')',PV2=locadj..' '..LOC('$$$/AgDevelop/Localized/Contrast=Contrast'),Group=localizedAdjustments,Explanation='Adjust Contrast for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Highlights',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Highlights=Highlights')..' (PV 3+)',PV3=locadj..' '..LOC('$$$/AgDevelop/Localized/Highlights=Highlights'),Group=localizedAdjustments,Explanation='Adjust Highlights for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Shadows',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Shadows=Shadows')..' (PV 3+)',PV3=locadj..' '..LOC('$$$/AgDevelop/Localized/Shadows=Shadows'),Group=localizedAdjustments,Explanation='Adjust Shadows for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Whites2012',Type='parameter',Experimental=true,Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Whites=Whites')..' (PV 3+)',PV3=locadj..' '..LOC('$$$/AgDevelop/Localized/Whites=Whites'),Group=localizedAdjustments,Explanation='Adjust Whites for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Blacks2012',Type='parameter',Experimental=true,Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Blacks=Blacks')..' (PV 3+)',PV3=locadj..' '..LOC('$$$/AgDevelop/Localized/Blacks=Blacks'),Group=localizedAdjustments,Explanation='Adjust Blacks for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Texture',Type='parameter',Translation=locadj..' '..LOC('$$$/AgCameraRawUI/Texture=Texture'),Group=localizedAdjustments,Explanation='Adjust Texture for the currently active tool: Brush, Radial Filter, or Graduated Filter. For Lightroom version 8.3 and later.'},
  {Command='local_Clarity',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Clarity=Clarity')..' ('..P2and3plus..')',PV2=locadj..' '..LOC('$$$/AgDevelop/Localized/Clarity=Clarity'),Group=localizedAdjustments,Explanation='Adjust Clarity for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Dehaze',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Dehaze=Dehaze')..' (PV 3+)',PV3=locadj..' '..LOC('$$$/AgDevelop/Localized/Dehaze=Dehaze'),Group=localizedAdjustments,Explanation='Adjust Dehaze for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Hue',Translation=locadj..' '..LOC('$$$/MIDI2LR/Database/Hue=Hue')..' (PV 5+)',PV5=locadj..' '..LOC('$$$/MIDI2LR/Database/Hue=Hue'),Group=localizedAdjustments,Explanation='Adjust Hue for the currently active tool: Brush, Radial Filter, or Graduated Filter. For Lightroom version 9.3 and later.'},
  {Command='local_Saturation',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Saturation=Saturation')..' ('..P2and3plus..')',PV2=locadj..' '..LOC('$$$/AgDevelop/Localized/Saturation=Saturation'),Group=localizedAdjustments,Explanation='Adjust Saturation for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Sharpness',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Sharpness=Sharpness')..' ('..P2and3plus..')',PV2=locadj..' '..LOC('$$$/AgDevelop/Localized/Sharpness=Sharpness'),Group=localizedAdjustments,Explanation='Adjust Sharpness for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  ...
  {Command='Resetlocal_Temperature',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Temperature=Temp.')..' (PV 3+)'),PV3=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Temperature=Temp.')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Tint',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Tint=Tint')..' (PV 3+)'),PV3=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Tint=Tint')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Exposure',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Exposure=Exposure')..' ('..P2and3plus..')'),PV2=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Exposure=Exposure')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Contrast',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Contrast=Contrast')..' ('..P2and3plus..')'),PV2=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Contrast=Contrast')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Highlights',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Highlights=Highlights')..' (PV 3+)'),PV3=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Highlights=Highlights')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Shadows',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Shadows=Shadows')..' (PV 3+)'),PV3=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Shadows=Shadows')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Whites2012',Type='button',Experimental=true,Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Whites=Whites')..' (PV 3+)'),PV3=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Whites=Whites')),Group=localadjresets,Explanation='Reset to default.'}, 
  {Command='Resetlocal_Blacks2012',Type='button',Experimental=true,Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Blacks=Blacks')..' (PV 3+)'),PV3=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Blacks=Blacks')),Group=localadjresets,Explanation='Reset to default.'}, 
  {Command='Resetlocal_Texture',Type='button',Experimental=true,Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgCameraRawUI/Texture=Texture')),Group=localadjresets,Explanation='Reset to default. For Lightroom version 8.3 and later.'},
  {Command='Resetlocal_Clarity',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Clarity=Clarity')..' ('..P2and3plus..')'),PV2=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Clarity=Clarity')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Dehaze',Type='button',Experimental=true,Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Dehaze=Dehaze')..' (PV 3+)'),PV3=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Dehaze=Dehaze')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Hue',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/MIDI2LR/Database/Hue=Hue')..' (PV 5+)'),PV5=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/MIDI2LR/Database/Hue=Hue')),Group=localadjresets,Explanation='Reset to default.'},  
  {Command='Resetlocal_Saturation',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Saturation=Saturation')..' ('..P2and3plus..')'),PV2=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Saturation=Saturation')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Sharpness',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Sharpness=Sharpness')..' ('..P2and3plus..')'),PV2=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Sharpness=Sharpness')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_LuminanceNoise',Type='button',Translation=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/LuminanceNoiseReduction=Luminence Noise Reduction')..' (PV 3+)'),PV3=LOC('$$$/MIDI2LR/Database/Reset1=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/LuminanceNoiseReduction=Luminence Noise Reduction')),Group=localadjresets,Explanation='Reset to default.'},
