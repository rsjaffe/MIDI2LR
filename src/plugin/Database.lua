...
--rating
  ...
  {Command='QuickDevTextureLarge',Type='button',Translation=quickdev..' '..LOC('$$$/AgCameraRawController/TargetAdjustment/Increase=Increase ^1: ^2',LOC('$$$/AgCameraRawUI/Texture=Texture'),'20'),Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Texture by 20 for all selected photos. Works in Library and Develop modules.'},
  {Command='QuickDevTextureLargeDec',Type='button',Translation=quickdev..' '..LOC('$$$/AgCameraRawController/TargetAdjustment/Decrease=Decrease ^1: ^2',LOC('$$$/AgCameraRawUI/Texture=Texture'),'-20'),Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Texture by -20 for all selected photos. Works in Library and Develop modules.'},
  {Command='QuickDevTextureSmall',Type='button',Translation=quickdev..' '..LOC('$$$/AgCameraRawController/TargetAdjustment/Increase=Increase ^1: ^2',LOC('$$$/AgCameraRawUI/Texture=Texture'),'5'),Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Texture by 5 for all selected photos. Works in Library and Develop modules.'},
  {Command='QuickDevTextureSmallDec',Type='button',Translation=quickdev..' '..LOC('$$$/AgCameraRawController/TargetAdjustment/Decrease=Decrease ^1: ^2',LOC('$$$/AgCameraRawUI/Texture=Texture'),'-5'),Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Texture by -5 for all selected photos. Works in Library and Develop modules.'},
  ...
  {Command='QuickDevDehazeLarge',Type='button',Translation=quickdev..' '..LOC('$$$/AgCameraRawController/TargetAdjustment/Increase=Increase ^1: ^2',LOC('$$$/AgCameraRawUI/DehazeAmount=Dehaze Amount'),'20'),Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Dehaze by 20 for all selected photos. Works in Library and Develop modules.'},
  {Command='QuickDevDehazeLargeDec',Type='button',Translation=quickdev..' '..LOC('$$$/AgCameraRawController/TargetAdjustment/Decrease=Decrease ^1: ^2',LOC('$$$/AgCameraRawUI/DehazeAmount=Dehaze Amount'),'-20'),Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Dehaze by -20 for all selected photos. Works in Library and Develop modules.'},
  {Command='QuickDevDehazeSmall',Type='button',Translation=quickdev..' '..LOC('$$$/AgCameraRawController/TargetAdjustment/Increase=Increase ^1: ^2',LOC('$$$/AgCameraRawUI/DehazeAmount=Dehaze Amount'),'5'),Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Dehaze by 5 for all selected photos. Works in Library and Develop modules.'},
  {Command='QuickDevDehazeSmallDec',Type='button',Translation=quickdev..' '..LOC('$$$/AgCameraRawController/TargetAdjustment/Decrease=Decrease ^1: ^2',LOC('$$$/AgCameraRawUI/DehazeAmount=Dehaze Amount'),'-5'),Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Dehaze by -5 for all selected photos. Works in Library and Develop modules.'},
...
--
  ...
  {Command='local_Hue',Translation=locadj..' '..LOC('$$$/AgCameraRawNamedSettings/SaveNamedDialog/Hue=Hue')..' (PV 5+)',PV5=locadj..' '..LOC('$$$/AgCameraRawNamedSettings/SaveNamedDialog/Hue=Hue'),Group=localizedAdjustments,Explanation='Adjust Hue for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
