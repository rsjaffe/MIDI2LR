   ...
   try {
      ...
      profile_location_button_.onClick = [this] {
         ...
         if (chooser.browseForDirectory()) {
            ...
            rsj::Log(fmt::format(FMT_STRING("Profile location set to {}."), profile_location.toStdString()));
      ...
      autohide_setting_.onValueChange = [this] {
         ...
         rsj::Log(
             fmt::format(FMT_STRING("Autohide time set to {} seconds."), settings_manager_.GetAutoHideTime()));
      };
      /* turn it on */
      activateLayout();
   }
