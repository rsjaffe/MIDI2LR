...
AppVeyor <img alt = "AppVeyor Build Status" src="https://ci.appveyor.com/api/projects/status/7l1x58lx70mqg090?svg=true"/> Waffle [![Stories in Ready](https://badge.waffle.io/rsjaffe/MIDI2LR.png?label=ready&title=Ready)](https://waffle.io/rsjaffe/MIDI2LR)
