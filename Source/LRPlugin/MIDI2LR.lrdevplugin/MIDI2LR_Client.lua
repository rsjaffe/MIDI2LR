...
local ACTIONS = {
    ...
    ['ResetTemperature'] = function () LRDevelopController.resetToDefault('ResetTemperature') end,
    ['ResetTint']        = function () LRDevelopController.resetToDefault('ResetTint') end,
    ['ResetExposure']    = function () LRDevelopController.resetToDefault('ResetExposure') end,
    ['ResetHighlights']  = function () LRDevelopController.resetToDefault('ResetHighlights') end,
    ['ResetShadows']     = function () LRDevelopController.resetToDefault('ResetShadows') end,
    ['ResetContrast']    = function () LRDevelopController.resetToDefault('ResetContrast') end,
    ['ResetWhites']      = function () LRDevelopController.resetToDefault('ResetWhites') end,
    ['ResetBlacks']      = function () LRDevelopController.resetToDefault('ResetBlacks') end,
    ['ResetClarity']     = function () LRDevelopController.resetToDefault('ResetClarity') end,
    ['ResetVibrance']    = function () LRDevelopController.resetToDefault('ResetVibrance') end,
    ['ResetSaturation']  = function () LRDevelopController.resetToDefault('ResetSaturation') end,
    ['ResetParametricDarks']                 = function () LRDevelopController.resetToDefault('ResetParametricDarks') end,
    ['ResetParametricLights']                = function () LRDevelopController.resetToDefault('ResetParametricLights') end,
    ['ResetParametricShadows']               = function () LRDevelopController.resetToDefault('ResetParametricShadows') end,
    ['ResetParametricHighlights']            = function () LRDevelopController.resetToDefault('ResetParametricHighlights') end,
    ['ResetParametricShadowSplit']           = function () LRDevelopController.resetToDefault('ResetParametricShadowSplit') end,
    ['ResetParametricMidtoneSplit']          = function () LRDevelopController.resetToDefault('ResetParametricMidtoneSplit') end,
    ['ResetParametricHighlightSplit']        = function () LRDevelopController.resetToDefault('ResetParametricHighlightSplit') end,
    ['ResetSharpness']                       = function () LRDevelopController.resetToDefault('ResetSharpness') end,
    ['ResetSharpenRadius']                   = function () LRDevelopController.resetToDefault('ResetSharpenRadius') end,
    ['ResetSharpenDetail']                   = function () LRDevelopController.resetToDefault('ResetSharpenDetail') end,
    ['ResetSharpenEdgeMasking']              = function () LRDevelopController.resetToDefault('ResetSharpenEdgeMasking') end,
    ['ResetLuminanceSmoothing']              = function () LRDevelopController.resetToDefault('ResetLuminanceSmoothing') end,
    ['ResetLuminanceNoiseReductionDetail']   = function () LRDevelopController.resetToDefault('ResetLuminanceNoiseReductionDetail') end,
    ['ResetLuminanceNoiseReductionContrast'] = function () LRDevelopController.resetToDefault('ResetLuminanceNoiseReductionContrast') end,
    ['ResetColorNoiseReduction']             = function () LRDevelopController.resetToDefault('ResetColorNoiseReduction') end,
    ['ResetColorNoiseReductionDetail']       = function () LRDevelopController.resetToDefault('ResetColorNoiseReductionDetail') end,
    ['ResetColorNoiseReductionSmoothness']   = function () LRDevelopController.resetToDefault('ResetColorNoiseReductionSmoothness') end,
    ['ResetDehaze']                          = function () LRDevelopController.resetToDefault('ResetDehaze') end,
}
