...
--rating
  ...
  {Command='QuickDevWBAuto',Type='button',Translation=quickdev..' '..whiteBalance..' '..LOC('$$$/AgCameraRawUI/WhiteBalance/Auto=Auto'),Group=photos,Explanation='Using the Library\'s quick develop mode, sets auto white balance for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevWBDaylight',Type='button',Translation=quickdev..' '..whiteBalance..' '..LOC('$$$/AgCameraRawUI/WhiteBalance/Daylight=Daylight'),Group=photos,Explanation='Using the Library\'s quick develop mode, sets daylight white balance for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevWBCloudy',Type='button',Translation=quickdev..' '..whiteBalance..' '..LOC('$$$/AgCameraRawUI/WhiteBalance/Cloudy=Cloudy'),Group=photos,Explanation='Using the Library\'s quick develop mode, sets cloudy white balance for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevWBShade',Type='button',Translation=quickdev..' '..whiteBalance..' '..LOC('$$$/AgCameraRawUI/WhiteBalance/Shade=Shade'),Group=photos,Explanation='Using the Library\'s quick develop mode, sets shade white balance for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevWBTungsten',Type='button',Translation=quickdev..' '..whiteBalance..' '..LOC('$$$/AgCameraRawUI/WhiteBalance/Tungsten=Tungsten'),Group=photos,Explanation='Using the Library\'s quick develop mode, sets tungsten white balance for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevWBFluorescent',Type='button',Translation=quickdev..' '..whiteBalance..' '..LOC('$$$/AgCameraRawUI/WhiteBalance/Fluorescent=Fluorescent'),Group=photos,Explanation='Using the Library\'s quick develop mode, sets fluorescent white balance for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevWBFlash',Type='button',Translation=quickdev..' '..whiteBalance..' '..LOC('$$$/AgCameraRawUI/WhiteBalance/Flash=Flash'),Group=photos,Explanation='Using the Library\'s quick develop mode, sets Auto flash balance for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},

  {Command='SetTreatmentBW',Type='button',Translation=quickdev..' '..LOC('$$$/AgLibrary/CameraRawView/Ops/SetGrayscale=Set treatment B&W'),Group=photos,Explanation='Using the Library\'s quick develop mode, sets the treatment to B&W for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='SetTreatmentColor',Type='button',Translation=quickdev..' '..LOC('$$$/AgCameraRawNamedSettings/SaveNamedDialog/TreatmentColor=Set treatment Color'),Group=photos,Explanation='Using the Library\'s quick develop mode, sets the treatment to Color for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
...
--
  ...
  {Command='Resetlocal_Temperature',Type='button',Translation=reset..' '..locadj' '..LOC('$$$/AgDevelop/Localized/Temperature=Temp.')..' (PV2012)',Group=localizedAdjustments,Explanation='Reset to default.'},
  {Command='Resetlocal_Tint',Type='button',Translation=reset..' '..locadj' '..LOC('$$$/AgDevelop/Localized/Tint=Tint')..' (PV2012)',Group=localizedAdjustments,Explanation='Reset to default.'},
  {Command='Resetlocal_Exposure',Type='button',Translation=reset..' '..locadj' '..LOC('$$$/AgDevelop/Localized/Exposure=Exposure')..' ('..PV2010and2012..')',Group=localizedAdjustments,Explanation='Reset to default.'},
  {Command='Resetlocal_Contrast',Type='button',Translation=reset..' '..locadj' '..LOC('$$$/AgDevelop/Localized/Contrast=Contrast')..' ('..PV2010and2012..')',Group=localizedAdjustments,Explanation='Reset to default.'},
  {Command='Resetlocal_Highlights',Type='button',Translation=reset..' '..locadj' '..LOC('$$$/AgDevelop/Localized/Highlights=Highlights')..' (PV2012)',Group=localizedAdjustments,Explanation='Reset to default.'},
  {Command='Resetlocal_Shadows',Type='button',Translation=reset..' '..locadj' '..LOC('$$$/AgDevelop/Localized/Shadows=Shadows')..' (PV2012)',Group=localizedAdjustments,Explanation='Reset to default.'},
  {Command='Resetlocal_Whites2012',Type='button',Experimental=true,Translation=reset..' '..locadj' '..LOC('$$$/AgDevelop/Localized/Whites=Whites')..' (PV2012)',Group=localizedAdjustments,Explanation='Reset to default.'}, 
  {Command='Resetlocal_Blacks2012',Type='button',Experimental=true,Translation=reset..' '..locadj' '..LOC('$$$/AgDevelop/Localized/Blacks=Blacks')..' (PV2012)',Group=localizedAdjustments,Explanation='Reset to default.'}, 
  {Command='Resetlocal_Clarity',Type='button',Translation=reset..' '..locadj' '..LOC('$$$/AgDevelop/Localized/Clarity=Clarity')..' ('..PV2010and2012..')',Group=localizedAdjustments,Explanation='Reset to default.'},
  {Command='Resetlocal_Dehaze',Type='button',Experimental=true,Translation=reset..' '..locadj' '..LOC('$$$/AgDevelop/Localized/Dehaze=Dehaze')..' (PV2012)',Group=localizedAdjustments,Explanation='Reset to default.'},
  {Command='Resetlocal_Saturation',Type='button',Translation=reset..' '..locadj' '..LOC('$$$/AgDevelop/Localized/Saturation=Saturation')..' ('..PV2010and2012..')',Group=localizedAdjustments,Explanation='Reset to default.'},
  {Command='Resetlocal_Sharpness',Type='button',Translation=reset..' '..locadj' '..LOC('$$$/AgDevelop/Localized/Sharpness=Sharpness')..' ('..PV2010and2012..')',Group=localizedAdjustments,Explanation='Reset to default.'},
  {Command='Resetlocal_LuminanceNoise',Type='button',Translation=reset..' '..locadj' '..LOC('$$$/AgDevelop/Localized/LuminanceNoiseReduction=Luminence Noise Reduction')..' (PV2012)',Group=localizedAdjustments,Explanation='Reset to default.'},
  {Command='Resetlocal_Moire',Type='button',Translation=reset..' '..locadj' '..LOC('$$$/AgDevelop/Localized/MoireReduction=Moire')..' (PV2012)',Group=localizedAdjustments,Explanation='Reset to default.'},
  {Command='Resetlocal_Defringe',Type='button',Translation=reset..' '..locadj' '..LOC('$$$/AgDevelop/Localized/Defringe=Defringe')..' (PV2012)',Group=localizedAdjustments,Explanation='Reset to default.'},
  {Command='Resetlocal_ToningLuminance',Type='button',Translation=reset..' '..locadj' '..LOC('$$$/AgCameraRawNamedSettings/SaveNamedDialog/Luminance=Luminanz')..' (PV2010)',Group=localizedAdjustments,Explanation='Reset to default.'},
  ...
  {Command='LocalPreset1',Type='button',Translation=locadjpre' 1',Group=localizedAdjustments,Explanation='Use preset 1 for localized adjustments.'},
  {Command='LocalPreset2',Type='button',Translation=locadjpre' 2',Group=localizedAdjustments,Explanation='Use preset 2 for localized adjustments.'},
  {Command='LocalPreset3',Type='button',Translation=locadjpre' 3',Group=localizedAdjustments,Explanation='Use preset 3 for localized adjustments.'},
  {Command='LocalPreset4',Type='button',Translation=locadjpre' 4',Group=localizedAdjustments,Explanation='Use preset 4 for localized adjustments.'},
  {Command='LocalPreset5',Type='button',Translation=locadjpre' 5',Group=localizedAdjustments,Explanation='Use preset 5 for localized adjustments.'},
  {Command='LocalPreset6',Type='button',Translation=locadjpre' 6',Group=localizedAdjustments,Explanation='Use preset 6 for localized adjustments.'},
  {Command='LocalPreset7',Type='button',Translation=locadjpre' 7',Group=localizedAdjustments,Explanation='Use preset 7 for localized adjustments.'},
  {Command='LocalPreset8',Type='button',Translation=locadjpre' 8',Group=localizedAdjustments,Explanation='Use preset 8 for localized adjustments.'},
  {Command='LocalPreset9',Type='button',Translation=locadjpre' 9',Group=localizedAdjustments,Explanation='Use preset 9 for localized adjustments.'},  
  {Command='LocalPreset10',Type='button',Translation=locadjpre' 10',Group=localizedAdjustments,Explanation='Use preset 10 for localized adjustments.'},  
  {Command='LocalPreset11',Type='button',Translation=locadjpre' 11',Group=localizedAdjustments,Explanation='Use preset 11 for localized adjustments.'},  
  {Command='LocalPreset12',Type='button',Translation=locadjpre' 12',Group=localizedAdjustments,Explanation='Use preset 12 for localized adjustments.'},  
  {Command='LocalPreset13',Type='button',Translation=locadjpre' 13',Group=localizedAdjustments,Explanation='Use preset 13 for localized adjustments.'},  
  {Command='LocalPreset14',Type='button',Translation=locadjpre' 14',Group=localizedAdjustments,Explanation='Use preset 14 for localized adjustments.'},  
  {Command='LocalPreset15',Type='button',Translation=locadjpre' 15',Group=localizedAdjustments,Explanation='Use preset 15 for localized adjustments.'}, 
  {Command='LocalPreset16',Type='button',Translation=locadjpre' 16',Group=localizedAdjustments,Explanation='Use preset 16 for localized adjustments.'},  
--
-- Misc
--
  {Command='QuickDevCropAspectOriginal',Type='button',Translation=quickdev..' '..setcropasp' '..LOC('$$$/AgLibrary/CameraRawView/Ops/CropName/Original=Original'),Group=crop,Explanation='Set crop ratio to original. Using the Library\'s quick develop mode, sets crop aspect for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevCropAspectAsShot',Type='button',Translation=quickdev..' '..setcropasp' '..LOC('$$$/AgLibrary/CameraRawView/Ops/CropName/AsShot=As shot'),Group=crop,Explanation='Set crop ratio to as shot. Using the Library\'s quick develop mode, sets crop aspect for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevCropAspect1x1',Type='button',Translation=quickdev..' '..setcropasp' '..LOC('$$$/AgLibrary/CameraRawView/Ops/CropNameConstruction=^1 x ^2','1','1'),Group=crop,Explanation='Set crop ratio to 1 by 1. Using the Library\'s quick develop mode, sets crop aspect for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevCropAspect4x5',Type='button',Translation=quickdev..' '..setcropasp' '..LOC('$$$/AgLibrary/CameraRawView/Ops/CropNameConstruction=^1 x ^2','4','5'),Group=crop,Explanation='Set crop ratio to 4 by 5. Using the Library\'s quick develop mode, sets crop aspect for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevCropAspect85x11',Type='button',Translation=quickdev..' '..setcropasp' '..LOC('$$$/AgLibrary/CameraRawView/Ops/CropNameConstruction=^1 x ^2','8.5','11'),Group=crop,Explanation='Set crop ratio to 8.5 by 11. Using the Library\'s quick develop mode, sets crop aspect for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevCropAspect5x7',Type='button',Translation=quickdev..' '..setcropasp' '..LOC('$$$/AgLibrary/CameraRawView/Ops/CropNameConstruction=^1 x ^2','5','7'),Group=crop,Explanation='Set crop ratio to 5 by 7. Using the Library\'s quick develop mode, sets crop aspect for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevCropAspect2x3',Type='button',Translation=quickdev..' '..setcropasp' '..LOC('$$$/AgLibrary/CameraRawView/Ops/CropNameConstruction=^1 x ^2','2','3'),Group=crop,Explanation='Set crop ratio to 2 by 3. Using the Library\'s quick develop mode, sets crop aspect for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
