...
--rating
  ...
  {Command='ResetTexture',Type='button',Translation=reset..LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/Texture=Texture'),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
