...
--rating
  ...
  {Command='LRCopy',Type='button',Translation='Lightroom '..LOC('$$$/AgLibrary/Menu/Develop/CopySettings=Copy Settings'):gsub('&',''),Group=develop,Explanation='Lightroom Copy (open the selection box). Sends the keystroke <kbd>\226\140\131 Control</kbd>+<kbd>c</kbd> (Windows) or <kbd>\226\140\152 Command</kbd>+<kbd>c</kbd> (OSX) to Lightroom.'},
  {Command='LRPaste',Type='button',Translation='Lightroom '..LOC('$$$/AgCameraRawNamedSettings/Ops/PasteSettings=Paste Settings'),Group=develop,Explanation='Lightroom Paste. Sends the keystroke <kbd>\226\140\131 Control</kbd>+<kbd>v</kbd> (Windows) or <kbd>\226\140\152 Command</kbd>+<kbd>v</kbd> (OSX) to Lightroom.'},
  ...
  {Command='Highlights',Type='parameter',Translation=LOC('$$$/AgCameraRawUI/Highlights=Highlights')..' ('..LOC('$$$/AgCameraRawUI/HighlightRecovery=Highlight Recovery')..' in '..PV2003and2010..')',Group=basicTone,Explanation='Adjusts bright image areas. Drag to the left to darken highlights and recover \226\128\156blown out\226\128\157 highlight details. Drag to the right to brighten highlights while minimizing clipping.<br /><br />In '..PV2003and2010..', controls recovery and reduces the tones of extreme highlights and attempts to recover highlight detail lost because of camera overexposure. Lightroom can recover detail in raw image files if one or two channels are clipped.',Panel='adjustPanel'},
  ...
  {Command='Shadows',Type='parameter',Translation=LOC('$$$/AgCameraRawUI/Shadows=Shadows')..' ('..LOC('$$$/AgCameraRawUI/FillLight=Fill Light')..' in '..PV2003and2010..')',Group=basicTone,Explanation='Adjusts dark image areas. Drag to the left to darken shadows while minimizing clipping. Drag to the right to brighten shadows and recover shadow details.<br /><br />In '..PV2003and2010..', controls Fill Light, and lightens shadow to reveal more detail while maintaining blacks. Take care not to over apply the setting and reveal image noise.',Panel='adjustPanel'},
