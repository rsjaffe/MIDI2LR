...
--rating
  ...
  {Command='QuickDevWBAuto',Type='button',Translation=quickdev..' '..whiteBalance..' '..LOC('$$$/AgCameraRawUI/WhiteBalance/Auto=Auto'),Group=photos,Explanation='Using the Library\226\128\153s quick develop mode, sets auto white balance for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevWBDaylight',Type='button',Translation=quickdev..' '..whiteBalance..' '..LOC('$$$/AgCameraRawUI/WhiteBalance/Daylight=Daylight'),Group=photos,Explanation='Using the Library\226\128\153s quick develop mode, sets daylight white balance for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevWBCloudy',Type='button',Translation=quickdev..' '..whiteBalance..' '..LOC('$$$/AgCameraRawUI/WhiteBalance/Cloudy=Cloudy'),Group=photos,Explanation='Using the Library\226\128\153s quick develop mode, sets cloudy white balance for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevWBShade',Type='button',Translation=quickdev..' '..whiteBalance..' '..LOC('$$$/AgCameraRawUI/WhiteBalance/Shade=Shade'),Group=photos,Explanation='Using the Library\226\128\153s quick develop mode, sets shade white balance for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevWBTungsten',Type='button',Translation=quickdev..' '..whiteBalance..' '..LOC('$$$/AgCameraRawUI/WhiteBalance/Tungsten=Tungsten'),Group=photos,Explanation='Using the Library\226\128\153s quick develop mode, sets tungsten white balance for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevWBFluorescent',Type='button',Translation=quickdev..' '..whiteBalance..' '..LOC('$$$/AgCameraRawUI/WhiteBalance/Fluorescent=Fluorescent'),Group=photos,Explanation='Using the Library\226\128\153s quick develop mode, sets fluorescent white balance for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevWBFlash',Type='button',Translation=quickdev..' '..whiteBalance..' '..LOC('$$$/AgCameraRawUI/WhiteBalance/Flash=Flash'),Group=photos,Explanation='Using the Library\226\128\153s quick develop mode, sets Auto flash balance for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},

  {Command='SetTreatmentBW',Type='button',Translation=quickdev..' '..LOC('$$$/AgLibrary/CameraRawView/Ops/SetGrayscale=Set treatment B&W'),Group=photos,Explanation='Using the Library\226\128\153s quick develop mode, sets the treatment to B&W for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='SetTreatmentColor',Type='button',Translation=quickdev..' '..LOC('$$$/AgCameraRawNamedSettings/SaveNamedDialog/TreatmentColor=Set treatment Color'),Group=photos,Explanation='Using the Library\226\128\153s quick develop mode, sets the treatment to Color for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
...
--
  ...
  {Command='DefringePurpleHueLo',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PurpleDefringeHueLo=Defringe Purple Hue')..' - '..LOC('$$$/Slideshow/Panels/PanAndZoom/Low=Low'),Group=lensCorrections,Explanation='See \226\128\152Defringe Purple Amount\226\128\153 description for details.',Panel='lensCorrectionsPanel'},
  {Command='DefringePurpleHueHi',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PurpleDefringeHueLo=Defringe Purple Hue')..' - '..LOC('$$$/Slideshow/Panels/PanAndZoom/High=High'),Group=lensCorrections,Explanation='See \226\128\152Defringe Purple Amount\226\128\153 description for details.',Panel='lensCorrectionsPanel'},
  ...
  {Command='DefringeGreenHueLo',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GreenDefringeHueLo=Defringe Green Hue')..' - '..LOC('$$$/Slideshow/Panels/PanAndZoom/Low=Low'),Group=lensCorrections,Explanation='See \226\128\152Defringe Green Amount\226\128\153 description for details.',Panel='lensCorrectionsPanel'},
  {Command='DefringeGreenHueHi',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GreenDefringeHueLo=Defringe Green Hue')..' - '..LOC('$$$/Slideshow/Panels/PanAndZoom/High=High'),Group=lensCorrections,Explanation='See \226\128\152Defringe Green Amount\226\128\153 description for details.',Panel='lensCorrectionsPanel'},
...
-- Misc
--
  {Command='QuickDevCropAspectOriginal',Type='button',Translation=quickdev..' '..setcropasp' '..LOC('$$$/AgLibrary/CameraRawView/Ops/CropName/Original=Original'),Group=crop,Explanation='Set crop ratio to original. Using the Library\226\128\153s quick develop mode, sets crop aspect for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevCropAspectAsShot',Type='button',Translation=quickdev..' '..setcropasp' '..LOC('$$$/AgLibrary/CameraRawView/Ops/CropName/AsShot=As shot'),Group=crop,Explanation='Set crop ratio to as shot. Using the Library\226\128\153s quick develop mode, sets crop aspect for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevCropAspect1x1',Type='button',Translation=quickdev..' '..setcropasp' '..LOC('$$$/AgLibrary/CameraRawView/Ops/CropNameConstruction=^1 x ^2','1','1'),Group=crop,Explanation='Set crop ratio to 1 by 1. Using the Library\226\128\153s quick develop mode, sets crop aspect for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  ...
  {Command='QuickDevCropAspect85x11',Type='button',Translation=quickdev..' '..setcropasp' '..LOC('$$$/AgLibrary/CameraRawView/Ops/CropNameConstruction=^1 x ^2','8.5','11'),Group=crop,Explanation='Set crop ratio to 8.5 by 11. Using the Library\226\128\153s quick develop mode, sets crop aspect for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
  {Command='QuickDevCropAspect5x7',Type='button',Translation=quickdev..' '..setcropasp' '..LOC('$$$/AgLibrary/CameraRawView/Ops/CropNameConstruction=^1 x ^2','5','7'),Group=crop,Explanation='Set crop ratio to 5 by 7. Using the Library\226\128\153s quick develop mode, sets crop aspect for all selected photos. Works in Library and Develop modules. Supported in LR versions 7.4 and later.'},
