...
--
  ...
  {"Profile_Camera_Scenery",false,false,true,false,true,true,LOC("$$$/CRaw/Style/Profile/CameraScenery=Camera Scenery"),calibration,"These profiles attempt to match the camera manufacturer\226\128\153s color appearance under specific settings. If Adobe doesn\226\128\153t have this profile set up for your camera, using it may have unexpected results. *button*",'calibratePanel'},
