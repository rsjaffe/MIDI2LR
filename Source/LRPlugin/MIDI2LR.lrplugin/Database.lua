...
--rating
  ...
  {Command='ChangeCurrentSlider',Type='repeat',Translation=LOC('$$$/ImportView/More=More')..' – '..LOC('$$$/ImportView/Less=Less'),Group=develop,Explanation='Adjusts selected develop slider up or down. Turning knob clockwise sends Increment (<kbd>\240\159\161\146 Cursor Right</kbd>) key strokes to Lightroom, counterclockwise Decrement (<kbd>\240\159\161\144 Cursor Left</kbd>).'..repeatexp},
  ...
  {Command='Highlights',Type='parameter',Translation=LOC('$$$/AgCameraRawUI/Highlights=Highlights')..' ('..LOC('$$$/AgCameraRawUI/HighlightRecovery=Highlight Recovery')..' in '..P1and2..')',Group=basicTone,Explanation='Adjusts bright image areas. Drag to the left to darken highlights and recover \226\128\156blown out\226\128\157 highlight details. Drag to the right to brighten highlights while minimizing clipping.<br /><br />In '..P1and2..', controls recovery and reduces the tones of extreme highlights and attempts to recover highlight detail lost because of camera overexposure. Lightroom can recover detail in raw image files if one or two channels are clipped.',Panel='adjustPanel'},
  ...
  {Command='Shadows',Type='parameter',Translation=LOC('$$$/AgCameraRawUI/Shadows=Shadows')..' ('..LOC('$$$/AgCameraRawUI/FillLight=Fill Light')..' in '..P1and2..')',Group=basicTone,Explanation='Adjusts dark image areas. Drag to the left to darken shadows while minimizing clipping. Drag to the right to brighten shadows and recover shadow details.<br /><br />In '..P1and2..', controls Fill Light, and lightens shadow to reveal more detail while maintaining blacks. Take care not to over apply the setting and reveal image noise.',Panel='adjustPanel'},
  {Command='Whites',Type='parameter',Translation=LOC('$$$/AgCameraRawUI/Whites=Whites')..' ('..LOC('$$$/MIDI2LR/Versions/notfor=doesn\226\128\153t work with')..' '..P1and2..')',Group=basicTone,Explanation='Adjusts white clipping. Drag to the left to reduce clipping in highlights. Drag to the right to increase highlight clipping.',Panel='adjustPanel'},
  ...
  {Command='Dehaze',Type='parameter',Translation=LOC('$$$/AgCameraRawUI/DehazeAmount=Dehaze Amount'),Group=basicTone,Explanation='Controls the amount of haze in a photograph. Drag to the right to remove haze; drag to the left to add haze.',Panel='adjustPanel'},
  ...
  {Command='ResetTint',Type='button',Translation=reset..' '..LOC('$$$/AgCameraRawUI/Tint=Tint'),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  ...
  {Command='ResetHighlights',Type='button',Translation=reset..' '..LOC('$$$/AgCameraRawUI/Highlights=Highlights'),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetShadows',Type='button',Translation=reset..' '..LOC('$$$/AgCameraRawUI/Shadows=Shadows'),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  ...
  {Command='ResetTexture',Type='button',Experimental=true,Translation=reset..LOC('$$$/AgCameraRawUI/Texture=Texture'),Group=basicTone,Explanation='Reset to default. For Lightroom version 8.3 and later.',Panel='adjustPanel'},
  {Command='ResetClarity',Type='button',Translation=reset..' '..LOC('$$$/AgCameraRawUI/Clarity=Clarity'),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetDehaze',Type='button',Translation=reset..' '..LOC('$$$/AgCameraRawUI/DehazeAmount=Dehaze Amount'),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},  
...
--
  ...
  {Command='local_Temperature',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Temperature=Temp.')..' (PV 3+)',Group=localizedAdjustments,Explanation='Adjust Temperature for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Tint',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Tint=Tint')..' (PV 3+)',Group=localizedAdjustments,Explanation='Adjust Tint for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Exposure',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Exposure=Exposure')..' ('..P2and3plus..')',Group=localizedAdjustments,Explanation='Adjust Exposure for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Contrast',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Contrast=Contrast')..' ('..P2and3plus..')',Group=localizedAdjustments,Explanation='Adjust Contrast for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Highlights',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Highlights=Highlights')..' (PV 3+)',Group=localizedAdjustments,Explanation='Adjust Highlights for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Shadows',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Shadows=Shadows')..' (PV 3+)',Group=localizedAdjustments,Explanation='Adjust Shadows for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Whites2012',Type='parameter',Experimental=true,Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Whites=Whites')..' (PV 3+)',Group=localizedAdjustments,Explanation='Adjust Whites for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Blacks2012',Type='parameter',Experimental=true,Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Blacks=Blacks')..' (PV 3+)',Group=localizedAdjustments,Explanation='Adjust Blacks for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Texture',Type='parameter',Experimental=true,Translation=locadj..' '..LOC('$$$/AgCameraRawUI/Texture=Texture'),Group=localizedAdjustments,Explanation='Adjust Texture for the currently active tool: Brush, Radial Filter, or Graduated Filter. For Lightroom version 8.3 and later.'},
  {Command='local_Clarity',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Clarity=Clarity')..' ('..P2and3plus..')',Group=localizedAdjustments,Explanation='Adjust Clarity for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Dehaze',Type='parameter',Experimental=true,Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Dehaze=Dehaze')..' (PV 3+)',Group=localizedAdjustments,Explanation='Adjust Dehaze for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Saturation',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Saturation=Saturation')..' ('..P2and3plus..')',Group=localizedAdjustments,Explanation='Adjust Saturation for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Sharpness',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Sharpness=Sharpness')..' ('..P2and3plus..')',Group=localizedAdjustments,Explanation='Adjust Sharpness for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_LuminanceNoise',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/LuminanceNoiseReduction=Luminence Noise Reduction')..' (PV 3+)',Group=localizedAdjustments,Explanation='Adjust Luminance Noise for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Moire',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/MoireReduction=Moire')..' (PV 3+)',Group=localizedAdjustments,Explanation='Adjust Moire for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_Defringe',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Defringe=Defringe')..' (PV 3+)',Group=localizedAdjustments,Explanation='Adjust Defringe for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  {Command='local_ToningLuminance',Type='parameter',Translation=locadj..' '..LOC('$$$/AgCameraRawNamedSettings/SaveNamedDialog/Luminance=Luminance')..' (PV 2)',Group=localizedAdjustments,Explanation='Adjust Toning Luminance for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
--local adjustment resets 
  ...
  {Command='Resetlocal_Temperature',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Temperature=Temp.')..' (PV 3+)',Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Tint',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Tint=Tint')..' (PV 3+)',Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Exposure',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Exposure=Exposure')..' ('..P2and3plus..')',Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Contrast',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Contrast=Contrast')..' ('..P2and3plus..')',Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Highlights',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Highlights=Highlights')..' (PV 3+)',Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Shadows',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Shadows=Shadows')..' (PV 3+)',Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Whites2012',Type='button',Experimental=true,Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Whites=Whites')..' (PV 3+)',Group=localadjresets,Explanation='Reset to default.'}, 
  {Command='Resetlocal_Blacks2012',Type='button',Experimental=true,Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Blacks=Blacks')..' (PV 3+)',Group=localadjresets,Explanation='Reset to default.'}, 
  {Command='Resetlocal_Texture',Type='button',Experimental=true,Translation=reset..' '..locadj..' '..LOC('$$$/AgCameraRawUI/Texture=Texture'),Group=localadjresets,Explanation='Reset to default. For Lightroom version 8.3 and later.'},
  {Command='Resetlocal_Clarity',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Clarity=Clarity')..' ('..P2and3plus..')',Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Dehaze',Type='button',Experimental=true,Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Dehaze=Dehaze')..' (PV 3+)',Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Saturation',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Saturation=Saturation')..' ('..P2and3plus..')',Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Sharpness',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Sharpness=Sharpness')..' ('..P2and3plus..')',Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_LuminanceNoise',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/LuminanceNoiseReduction=Luminence Noise Reduction')..' (PV 3+)',Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Moire',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/MoireReduction=Moire')..' (PV 3+)',Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Defringe',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Defringe=Defringe')..' (PV 3+)',Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_ToningLuminance',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgCameraRawNamedSettings/SaveNamedDialog/Luminance=Luminanz')..' (PV 2)',Group=localadjresets,Explanation='Reset to default.'}, 
