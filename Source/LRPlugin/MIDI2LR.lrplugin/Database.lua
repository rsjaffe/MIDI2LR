...
--rating
  ...
  {Command='Dehaze',Type='parameter',Translation=LOC('$$$/AgCameraRawUI/DehazeAmount=Dehaze Amount')..' (PV 3+)',PV3=LOC('$$$/AgCameraRawUI/DehazeAmount=Dehaze Amount'),Group=basicTone,Explanation='Controls the amount of haze in a photograph. Drag to the right to remove haze; drag to the left to add haze.',Panel='adjustPanel'},
...
--
  ...
  {Command='local_Dehaze',Type='parameter',Experimental=true,Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Dehaze=Dehaze')..' (PV 3+)',PV3=locadj..' '..LOC('$$$/AgDevelop/Localized/Dehaze=Dehaze'),Group=localizedAdjustments,Explanation='Adjust Dehaze for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
  ...
  {Command='local_LuminanceNoise',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/LuminanceNoiseReduction=Luminence Noise Reduction')..' (PV 3+)',PV3=locadj..' '..LOC('$$$/AgDevelop/Localized/LuminanceNoiseReduction=Luminence Noise Reduction'),Group=localizedAdjustments,Explanation='Adjust Luminance Noise for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
...
--local adjustment resets 
  ...
  {Command='Resetlocal_Temperature',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Temperature=Temp.')..' (PV 3+)',PV3=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Temperature=Temp.'),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Tint',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Tint=Tint')..' (PV 3+)',PV3=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Tint=Tint'),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Exposure',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Exposure=Exposure')..' ('..P2and3plus..')',PV2=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Exposure=Exposure'),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Contrast',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Contrast=Contrast')..' ('..P2and3plus..')',PV2=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Contrast=Contrast'),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Highlights',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Highlights=Highlights')..' (PV 3+)',PV3=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Highlights=Highlights'),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Shadows',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Shadows=Shadows')..' (PV 3+)',PV3=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Shadows=Shadows'),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Whites2012',Type='button',Experimental=true,Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Whites=Whites')..' (PV 3+)',PV3=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Whites=Whites'),Group=localadjresets,Explanation='Reset to default.'}, 
  {Command='Resetlocal_Blacks2012',Type='button',Experimental=true,Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Blacks=Blacks')..' (PV 3+)',PV3=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Blacks=Blacks'),Group=localadjresets,Explanation='Reset to default.'}, 
  ...
  {Command='Resetlocal_Clarity',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Clarity=Clarity')..' ('..P2and3plus..')',PV2=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Clarity=Clarity'),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Dehaze',Type='button',Experimental=true,Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Dehaze=Dehaze')..' (PV 3+)',PV3=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Dehaze=Dehaze'),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Saturation',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Saturation=Saturation')..' ('..P2and3plus..')',PV2=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Saturation=Saturation'),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Sharpness',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Sharpness=Sharpness')..' ('..P2and3plus..')',PV2=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Sharpness=Sharpness'),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_LuminanceNoise',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/LuminanceNoiseReduction=Luminence Noise Reduction')..' (PV 3+)',PV3=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/LuminanceNoiseReduction=Luminence Noise Reduction'),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Moire',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/MoireReduction=Moire')..' (PV 3+)',PV3=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/MoireReduction=Moire'),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Defringe',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Defringe=Defringe')..' (PV 3+)',PV3=reset..' '..locadj..' '..LOC('$$$/AgDevelop/Localized/Defringe=Defringe'),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_ToningLuminance',Type='button',Translation=reset..' '..locadj..' '..LOC('$$$/AgCameraRawNamedSettings/SaveNamedDialog/Luminance=Luminanz')..' (PV 2)',PV2=reset..' '..locadj..' '..LOC('$$$/AgCameraRawNamedSettings/SaveNamedDialog/Luminance=Luminanz'),PV3=reset..' '..locadj..' '..LOC('$$$/AgCameraRawNamedSettings/SaveNamedDialog/Luminance=Luminanz')..' (PV 2)',Group=localadjresets,Explanation='Reset to default.'}, 
