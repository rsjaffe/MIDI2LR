...
--rating
  ...
  {Command='ResetTexture',Type='button',Experimental=true,Translation=reset..LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/Texture=Texture'),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
...
--
  ...
  {Command='local_Texture',Type='parameter',Experimental=true,Translation=locadj..' '..LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/Texture=Texture'),Group=localizedAdjustments,Explanation='Adjust Texture for the currently active tool: Brush, Radial Filter, or Graduated Filter.'},
...
--local adjustment resets 
  ...
  {Command='Resetlocal_Texture',Type='button',Experimental=true,Translation=reset..' '..locadj..' '..LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/Texture=Texture'),Group=localadjresets,Explanation='Reset to default.'},
