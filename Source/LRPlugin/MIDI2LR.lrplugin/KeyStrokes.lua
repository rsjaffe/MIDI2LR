...
table.sort(stringset,function(a,b) return string.sub(a[1],(string.find(a[1],'=')+1)) < string.sub(b[1],(string.find(b[1],'=')+1)) end)

local assignKeys = {}
for _,v in ipairs(stringset) do
  assignKeys[string.gsub(string.sub(v[1],5,(string.find(v[1],'=')-1)),'/','')] = LOC(v[1])
end
