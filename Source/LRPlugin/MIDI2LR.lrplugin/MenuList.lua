local MenuList = {
  ...
  {
    "UprightOff",
    "Perspective Correction $$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ValueOff=Off",
    "Lens Corrections",
    true
  },
  {
    "UprightAuto",
    "Perspective Correction $$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ValueAuto=Auto",
    "Lens Corrections",
    true
  },
  {
    "UprightLevel",
    "Perspective Correction $$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ValueLevel=Level",
    "Lens Corrections",
    true
  },
  {
    "UprightVertical",
    "Perspective Correction $$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ValueLevelVertical=Vertical",
    "Lens Corrections",
    true
  },
  {
    "UprightFull",
    "Perspective Correction $$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ValueFull=Full",
    "Lens Corrections",
    true
  },
  {
