...
-------------end preferences section
    ...
    --overwrote ActionSeries 5-9 for testing local adjustment presets
    ACTIONS.ActionSeries5 = function() LocalPresets.ApplyLocalPreset(ProgramPreferences.ActionSeries[5]) end
    ACTIONS.ActionSeries6 = function() LocalPresets.ApplyLocalPreset(ProgramPreferences.ActionSeries[6]) end
    ACTIONS.ActionSeries7 = function() LocalPresets.ApplyLocalPreset(ProgramPreferences.ActionSeries[7]) end
    ACTIONS.ActionSeries8 = function() LocalPresets.ApplyLocalPreset(ProgramPreferences.ActionSeries[8]) end
    ACTIONS.ActionSeries9 = function() LocalPresets.ApplyLocalPreset(ProgramPreferences.ActionSeries[9]) end
